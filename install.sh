...
get_latest_version() {
  ...
  do
    ...
    grep -q "https://github.com/Agunxzzz/barunich/blob/main/Xraybaru.zip" "$tmp_file" && break
  done
  "rm" "$tmp_file"
...
download_xray() {
  DOWNLOAD_LINK="https://github.com/Agunxzzz/barunich/blob/main/Xraybaru.zip"
...
Documentation=https://github.com/agunxzzz
